  ...
  return(
    <div>
      <div style={{marginBottom:18}}>
        <h1 style={{fontFamily:"Syne,sans-serif",fontSize:mob?18:22,fontWeight:800,color:TX}}>Good morning, Pola</h1>
      ...
      {inv&&(
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.7)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:100,padding:20}}>
          <div style={{background:S1,border:`1px solid ${BD}`,borderRadius:20,padding:26,width:"100%",maxWidth:320}} className="pop">
            ...
            <div style={{background:S2,border:`1px dashed ${R}50`,borderRadius:12,padding:18,textAlign:"center",fontFamily:"Syne,sans-serif",fontSize:28,fontWeight:800,color:R,letterSpacing:5,marginBottom:6}}>FS-7X4K</div>
